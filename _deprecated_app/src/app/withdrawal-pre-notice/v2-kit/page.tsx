...
import { withdrawalPreNoticeV2KitMock as mock } from "./_mock";

export default function WithdrawalPreNoticeV2KitPage() {
	return (
		<DetailShell title={mock.header} bottom={<StickyCTA text={mock.cta} />}>
			<PayContent>
				...
				<InfoBox
					title={mock.warningTitle}
					bullets={mock.warningBullets}
				/>
				<InfoBox
					title={mock.linkedTitle}
					bullets={mock.linkedBullets}
				/>
				<TermsRow
