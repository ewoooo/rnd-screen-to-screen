...
import { signupProcessingV1KitMock as mock } from "./_mock";

export default function SignupProcessingV1KitPage() {
	return (
		<DetailShell title={mock.header} bottom={<StickyCTA text={mock.cta} />}>
			<PayContent>
				...
				<StatusRowList title={mock.notify.title} items={mock.notify.items} />
