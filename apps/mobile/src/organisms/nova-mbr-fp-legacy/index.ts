...
/**
 * @deprecated Retired NOVA-MBR-FP organism registry.
 * Keep only for existing FP legacy routes and comparison renders.
 * New MBR FP work must define fresh OGN boundaries from Map/Diagram.
 */
