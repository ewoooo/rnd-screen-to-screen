...
| --- | --- | --- |
| Current implementation | `apps/mobile/src/app/(mbr)/NOVA-MBR-PG-003-0/Screen.tsx` | visible copy, slot ownership, component vocabulary |
| Route config | `apps/mobile/src/app/(mbr)/NOVA-MBR-PG-003-0/Screen.config.ts` | registered policy refs and OGN ids |
...
| Legacy auth reference | `apps/mobile/src/app/(legacy-converted-mbr)/LEGACY-MBR-PG-001-0-CX/Screen.map.md` | auth policy interpretation and governance precedent |
