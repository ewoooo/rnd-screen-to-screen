...
export function BillingPayMethodScreen({
	...
	const defaultId = methods.items.find((it) => it.defaultChecked)?.id ?? methodItems[0]?.id;

	const targetItems: InfoListItem[] = [
		{ id: "line", title: "회선", sub: "", trailingLabel: target.line },
		{ id: "period", title: "청구월", sub: "", trailingLabel: target.period },
		{ id: "amount", title: "납부 금액", sub: "", trailingLabel: target.amount },
	];
