...
export function BillingPayConfirmScreen({
	...
	const summaryItems: InfoListItem[] = [
		{ id: "line", title: "회선", sub: "", trailingLabel: summary.line },
		{ id: "period", title: "청구월", sub: "", trailingLabel: summary.period },
		{ id: "amount", title: "납부 금액", sub: "", trailingLabel: summary.amount },
	];
