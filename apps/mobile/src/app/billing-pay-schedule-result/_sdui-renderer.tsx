...
export function BillingPayScheduleResultScreen({
	spec,
}: {
	...
	return (
		<AppScreen
			top={<ProgressTopBar title="예약 결과" leading="close" />}
			bottom={
				<PrimaryCTABar
...
function readData<T>(spec: RenderableScreenSpecV1, key: string): T {
	...
	if (!value || typeof value !== "object" || Array.isArray(value)) {
		throw new Error(`billing-pay-schedule-result spec missing data.${key}`);
	}
