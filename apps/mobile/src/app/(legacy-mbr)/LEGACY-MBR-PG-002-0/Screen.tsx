		...
		<AppScreen>
			...
			<AppScreen.Header>
				<ProgressTopBar
					title="가입 완료"
					leading="back"
					progress={{ label: "회원 가입 5/5", percent: 100, showLabel: true }}
				/>
			</AppScreen.Header>
			<AppScreen.Content>
				<MembershipHeroSection
					titleLines={["환영합니다,", "우주에 오신 걸"]}
					description="가입이 완료되었어요. 자동 로그인 상태이며, 첫 화면부터 모든 서비스를 이용할 수 있어요."
				/>
				<MembershipSummarySection
					label="가입 정보"
					title="이 정보로 가입이 완료됐어요"
					items={[
						{ id: "id", title: "회원 ID", sub: "wooseong****", trailingLabel: "본인" },
						{ id: "joined-at", title: "가입일", sub: "2026년 4월 30일 (수)" },
						{ id: "session", title: "자동 로그인", sub: "이 기기에서 30일 유지", trailingLabel: "활성" },
					]}
				/>
				<MembershipNoticeSection
					badge="혜택"
