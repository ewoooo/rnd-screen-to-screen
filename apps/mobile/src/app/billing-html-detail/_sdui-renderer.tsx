...
type ItemsData = { title: string; rows: readonly InfoListItem[] };
type DeltaData = {
...
export function BillingDetailScreen({ spec }: { spec: RenderableScreenSpecV1 }) {
	...
	return (
		<AppScreen top={<ProgressTopBar title="청구 상세" leading="back" />}>
			<SummaryCard label={total.label} title={total.title} mediaAlt={total.label}>
				<InfoList
