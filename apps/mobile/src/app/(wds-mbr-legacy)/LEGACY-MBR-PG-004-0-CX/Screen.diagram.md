...
- wireReference:
  - source: `apps/mobile/src/app/(cx-example)/CX-EXAMPLE-PERSONAL-INFO-INPUT/Screen.diagram.md`
...
- referenceSearch:
  ...
  - `apps/mobile/src/app/(wds-mbr-legacy)/LEGACY-MBR-PG-003-0-CX/Screen.diagram.md`: useful sibling withdrawal flow evidence, but rejected as primary because it is a completion pattern.
