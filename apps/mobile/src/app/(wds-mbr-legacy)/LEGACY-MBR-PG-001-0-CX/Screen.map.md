...
| Current diagram | `apps/mobile/src/app/(wds-mbr-legacy)/LEGACY-MBR-PG-001-0-CX/Screen.diagram.md` | 최신 Screen Contract, section contract, layoutContract, component candidate 연결 |
