...
- reference pack: `apps/mobile/src/diagrams/skt-genui-test-0512/node-14243-28433/frame-02.diagram.md`
- source: `Figma`
...
│ [stickyDeviceSummary]                                    │
│  ┌────────────────────────────────────────────────────┐  │
│  │ (thumbnail) iPhone 20 Pro 코스믹 오렌지 512G   + │  │
│  │             129,797원 /월                         │  │
│  │             (부가세, 할부수수료 포함)             │  │
│  └────────────────────────────────────────────────────┘  │
│                                                          │
...
│  label 휴대폰 모델명                   등급산정기준 보기 │
│  ┌──────────────────────────────┐ ┌───────────────┐     │
│  │ 아이폰14 256GB               │ │ 검색          │     │
│  └──────────────────────────────┘ └───────────────┘     │
│  help 예시 : 갤럭시 S10, 갤럭시 노트9                   │
│  ──────────────────────────────────────────────────────  │
...
- Keep visible section divider bands as real section breaks. In diagrams they must appear as `├══Divider(section band)`.
