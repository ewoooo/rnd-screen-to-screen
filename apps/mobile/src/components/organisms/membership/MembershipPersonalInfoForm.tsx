...
export type MembershipFieldKind = "text" | "tel" | "date" | "selectable";

export type MembershipPersonalField = {
	id: string;
...
export type MembershipPersonalValues = Record<string, string | undefined>;

type Props = {
	fields: readonly MembershipPersonalField[];
	values: MembershipPersonalValues;
	errors: Record<string, string | undefined>;
	onChange: (id: string, value: string) => void;
};

export function MembershipPersonalInfoForm({
	fields,
	values,
	errors,
	onChange,
