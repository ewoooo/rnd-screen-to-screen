...
Section boundary는 route margin이나 empty spacer가 아니라 이 pattern으로 표현한다. 4px section divider와 1px hairline divider의 사용 기준은 `DESIGN_PATTERNS.md`와 를 따른다.

## Import

```tsx
import { SectionDivider } from "@pxds/cx-layout/components";
```
