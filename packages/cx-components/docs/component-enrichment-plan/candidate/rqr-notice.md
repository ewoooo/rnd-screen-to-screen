...
## Current Source
- Inventory: ../../component-inventory.md -> components/candidate/rqr-notice.md
- Component README:
- Implementation: packages/cx-components/src/candidate/rqr-notice
