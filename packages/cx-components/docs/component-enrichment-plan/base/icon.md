...
## Current Source
- Inventory: ../../component-inventory.md -> components/base/icon.md
- Component README: packages/cx-components/src/components/icon/icon.readme.md
- Implementation: packages/cx-components/src/components/icon
