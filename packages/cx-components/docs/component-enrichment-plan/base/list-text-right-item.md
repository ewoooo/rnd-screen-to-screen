...
- Component README: packages/cx-components/src/components/list-text-right-item/list-text-right-item.readme.md
- Implementation: packages/cx-components/src/components/list-text-right-item
