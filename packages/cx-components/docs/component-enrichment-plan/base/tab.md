...
## Current Source
- Inventory: ../../component-inventory.md -> components/base/tab.md
- Component README: packages/cx-components/src/components/tab/tab.readme.md
- Implementation: packages/cx-components/src/components/tab
