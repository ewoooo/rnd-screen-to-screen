...
export function StatusBar({
	...
	return (
		...
		>
			...
			<span
				className="cx-status-bar__right"
...
function DefaultSystemIndicators() {
	return (
		<span className="cx-status-bar__indicators">
			<svg
				className="cx-status-bar__cellular"
				width="18"
				height="12"
				viewBox="0 0 18 12"
				fill="none"
			...
			<svg
				className="cx-status-bar__battery"
				width="28"
				height="13"
				viewBox="0 0 28 13"
				fill="none"
