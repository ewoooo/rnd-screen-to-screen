// AUTO-GENERATED from ./generator-core.js. Do not edit by hand.
// Keep the readable Figma generator implementation in generator-core.js.
export const FIGMA_GENERATOR_CORE_SOURCE = [
	"// =============================================",
