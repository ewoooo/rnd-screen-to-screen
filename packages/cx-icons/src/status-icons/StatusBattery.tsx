	...
	function StatusBattery(props, ref) {
		return (
			...
			>
				...
				/>
				<path
					d="M2.34375 3.6224C2.34375 2.88602 2.9407 2.28906 3.67708 2.28906H22.0724C22.8088 2.28906 23.4057 2.88602 23.4057 3.6224V9.36568C23.4057 10.1021 22.8088 10.699 22.0724 10.699H3.67708C2.9407 10.699 2.34375 10.1021 2.34375 9.36568V3.6224Z"
					fill="currentColor"
				/>
			</svg>
		);
