 ...
 *   - packages/screens/src/active-spec-list.ts: 30 imports + 30 entries × 2 maps
 *   - packages/screens/src/index.ts: 30 screens entries
 *
...
const SPEC_LIST = resolve(REPO_ROOT, "packages/screens/src/active-spec-list.ts");
const INDEX_TS = resolve(REPO_ROOT, "packages/screens/src/index.ts");
