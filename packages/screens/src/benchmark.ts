...
export const benchmarkCriteria = [
	...
	},
	{
		...
		apiRefs: ["TextBlockVariant", "SpacingToken", "semanticSurface", "brand-tokens", "wds-token-registry"],
		evidence: [
			"spacing uses SpacingToken or var(--spacing-*)",
			"colors use WDS semantic tokens or documented project aliases",
	...
	},
	{
		...
		apiRefs: ["@screen/screens", "apps/preview", "ScreenEntry"],
	...
	},
	{
		...
		apiRefs: ["packages/screens/spec/active", "screen_contract", "areas"],
	...
	},
	{
		...
		apiRefs: ["@screen/screens", "spec/active", "mocks", "preview iframe"],
